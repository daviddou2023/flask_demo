...
async function updateHealthData() {
    ...
    document.getElementById('heartRate').textContent = healthData.heart_rate ? healthData.heart_rate : "--";
    document.getElementById('spo2').textContent = healthData.spo2 ? healthData.spo2 : "--";
}
